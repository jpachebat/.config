...
| Key | Action | Description |
|-----|--------|-------------|
| `<C-c><C-c>` | Toggle sidebar | Toggle Claude Code sidebar (any mode) |
| `<C-c>` (Claude terminal) | Close sidebar | Exit Claude terminal and hide window |
| `<leader>aT` | Toggle Claude | Alternate Claude Code toggle |
